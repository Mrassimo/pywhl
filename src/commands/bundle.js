    ...
    try {
      ...
      if (options.includeDeps) {
        ...
        for (const [depName, depInfo] of deps) {
          ...
          const depResult = await repoManager.searchPackageAcrossRepos(depName, depInfo.version);
          const depReleases = depResult.packageInfo.releases[depInfo.version] || [];
...
async function createBundleInstaller(bundleDir, packages) {
